    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase" style="letter-spacing: 5px;">P-Card Members</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="AdminHome.php">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Parking Card</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid booking mt-5 pb-5">
    <div class="container pb-5">
        <div class="bg-light shadow" style="padding: 30px;">
            <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">P-Card Members</h6>
            <hr>
            <!-- Search Box -->
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <div class="form-group">
                    <label for="searchStudentID">Search by Student ID:</label>
                    <input type="text" class="form-control" id="searchStudentID" name="searchStudentID" placeholder="Enter Student ID" style="max-width: 200px;">
                </div>
            ...
            // Check if the form has been submitted for searching
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $searchStudentID = $_POST["searchStudentID"];
                
                // SQL query to fetch the specified student ID record
                $sql_search = "SELECT * FROM pcard WHERE student_id = '$searchStudentID'";
                ...
                if ($result_search->num_rows > 0) {
                    ...
                    // Output data of the specified student ID record
                ...
                // SQL query to fetch all records from the pcard table
                $sql_all = "SELECT * FROM pcard";
                $result_all = $conn->query($sql_all);

                if ($result_all->num_rows > 0) {
                    // Output table headers for all records
                    echo "<table border='1' style='width: 100%;'>
                            <tr>
                                <th>Name</th>
                                <th>Course</th>
                    ...
                    // Output data of each row for all records
