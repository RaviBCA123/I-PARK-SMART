...
<body>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="AdminContact.php" class="dropdown-item active">Contact</a>
    ...
    <div class="container-fluid booking mt-5 pb-5">
        <div class="container pb-5">
            ...
            <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Queries From Users</h6><hr>
            <?php
                            ...
                            // SQL query to select all details from the table
