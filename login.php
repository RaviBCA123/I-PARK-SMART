...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($student_id) || empty($password)) {
        ...
        $stmt = $conn->prepare("SELECT id, username, password FROM users WHERE student_id = ?");
        ...
        if ($result->num_rows == 1) {
            ...
            if ($password === $stored_password) {
                ...
                header("Location: userHome.php"); // Redirect to the dashboard
                exit();
            } else {
            ...
            <div class="card-body rounded-bottom bg-white p-5"  style="width: 600px;" >
                <form action="#" method="post">
                    ...
                    <div style="margin-top: 10px;">
                        <p style="text-align: left; display: inline; margin-top: 20%;">Not a Member?</p><a href="./register.php" style="display: inline;">Register Here.</a>
                        <p style="text-align: right; display: inline; margin-left: 25%; margin-top: 20%;"><a href="forgot.php">Forgot password?</a></p>    
                    </div>
