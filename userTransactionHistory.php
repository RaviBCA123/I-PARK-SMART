...
<body>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="profileDropdown">
                                ...
                                <a class="dropdown-item active" href="userTransactionHistory.php">Transaction History</a>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase" style="letter-spacing: 5px;">Transaction</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="userHome.php">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Transaction History</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid booking mt-5 pb-5">
        <div class="container pb-5">
            ...
            <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Transaction & History</h6><hr>
            ...
            <?php
                ...
                // Prepare SQL statement to fetch all records from the transaction table for the logged-in user
                $sql = "SELECT id, gate_number, amount,credit,balance,transaction_type, created_at FROM transaction WHERE username = ? ORDER BY created_at DESC";
