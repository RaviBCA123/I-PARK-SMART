...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="userParkingCard.php" class="nav-item nav-link active">Parking Card</a>
    ...
    <div class="container py-5">
        <div class="text-center mb-3 pb-3">
            <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Here is Your,</h6>
            <!--<h1 style="font-size: 30px;">P-Card</h1>-->
        </div>
        ...
        <div class="contact-form bg-white" style="padding: 30px; border: 2px solid #000; text-align: center; border-radius: 10px;">
                <?php
                    ...
                    $stmt = $conn->prepare("SELECT * FROM pcard WHERE username = ?");
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        $qr_text = "Name: " . $row['name'] . "\n";
                        $qr_text .= "Email: " . $row['email'] . "\n";
                        $qr_text .= "Roll No: " . $row['rollno'] . "\n";
                        $qr_text .= "Course: " . $row['course'] . "\n";
                        $qr_text .= "Student ID: " . $row['student_id'] . "\n";
                        $qr_text .= "Mobile: " . $row['mobile'] . "\n";
                        $qr_text .= "Vehicle Number: " . $row['vehicle_number'] . "\n";
                        $qr_text .= "Address: " . $row['address'] . "\n";
                        $qr_text .= "Balance: " . $row['balance'] . "\n";

                        // Ensure the 'qr_codes' directory exists and is writable
                        $qr_file = 'qr_codes/' . $username . '_qr.png';
                        include('phpqrcode/qrlib.php');
                        QRcode::png($qr_text, $qr_file, QR_ECLEVEL_L, 4);

                        // Display QR code and details
                        echo "<h3>AGC P-CARD</h3>";
                        echo "<hr><img src='$qr_file' alt='QR Code'>";
                        echo "<br>" . $row['name'];
                        echo "<br><b>" . $row['student_id'] . "</b><hr>";
                       
                    } else {
                        echo "No user found with the username: " . $username;
                        echo "<br>Apply for Parking Card <a href='userPCardApplication.php'> Application</a>";
                    }
