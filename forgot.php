...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and execute the SQL select statement to get the email and password
    $sql1 = "SELECT email,name, password FROM users WHERE student_id = ?";
    ...
    $stmt1->bind_result($retrievedEmail,$name, $password);
    ...
    if ($stmt1->num_rows > 0) {
        // Send email if a row was found
        sendEmail($retrievedEmail, $name, $password);
        echo '<script>alert("Password Sent Successfully on Email!");</script>';
...
function sendEmail($email, $name, $password) {
    try {
        ...
        We've received a request to recover your password.<br><br>
        
        <h3>Your password is: $password</h3><br><br>
        
        Now You can Login with the password we provided, and Also you can change your password from your Account.<br>
        If you have any questions or concerns, please don't hesitate to contact our support team at iparksmart45@gmail.com or +91 2041038200.<br><br><br>
...
<body>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="profileDropdown">
                                <a class="dropdown-item active" href="login.php">Student Login</a>
    ...
    style="background-image: url('./img/login.jpg'); background-size:cover; margin-bottom: 70px; max-width: 1700px; ">
        <div class="card border-0" >
            <div class="card-header bg-primary text-center p-4" >
                <h1 class="text-white m-0">Forgot password</h1>
            </div>
            <div class="card-body rounded-bottom bg-white p-5"  style="width: 600px;" >
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control p-4" name="student_id" placeholder="Your Student ID" required="required" />
                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control p-4" name="email" placeholder="Your email" required="required"/>
                    </div>
                    <div>
                        <button class="btn btn-primary btn-block py-3" name="forgot_btn" type="submit">Get password</button>
                    </div>
                </form>
                <div class="d-flex justify-content-center">
                    <p style="margin-top: 10px;">Go to<a href="./login.php"> Login!</a></p>
                </div>
            </div>
        </div>
    </div>
