                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="profileDropdown">
                                ...
                                <a class="dropdown-item active" href="userWallet.php">Wallet</a>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase "style="letter-spacing: 5px;">Wallet</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="userHome.php">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Wallet</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- wallet Start -->
    <div class="container-fluid booking mt-5 pb-5">
        <div class="container pb-5">
            ...
            <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Wallet</h6><hr>
            <h1>Balance</h1>
            <?php
            ...
            ?>
            <hr>
            <form action="userAddMoney.php" method="post">
                <div class="form-group">
                    <label for="addmoney">TopUp Wallet</label>
                    <input type="text" class="form-control" name="addmoney" id="addmoney" required="required" placeholder="100, 200, 300">
                </div>
                <div class="form-group mb-0">
                    <a href="Payment/index.php" class="btn btn-primary font-weight-semi-bold py-2 px-3">Proceed to TopUp</a>
                </div>
            </form>
            <!-- Script to set the selected package amount to "TopUp Wallet" input field -->
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    // Retrieve the selected package amount from local storage
                    var selectedPackageAmount = localStorage.getItem('selectedPackageAmount');

                    // If a package amount is found, set it as the value of the "TopUp Wallet" input field
                    if (selectedPackageAmount) {
                        document.getElementById('addmoney').value = selectedPackageAmount;
                    }

                    // Clear the selected package amount from local storage
                    localStorage.removeItem('selectedPackageAmount');
                });
            </script>
            <hr>
            <div class="form-group mb-0">
                    <a href="userTransactionHistory.php" class="btn btn-primary font-weight-semi-bold py-2 px-3">Transaction History</a> 
                </div>
