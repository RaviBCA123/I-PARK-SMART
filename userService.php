            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="userService.php" class="nav-item nav-link active">Services</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                ...
                                <a href="userTestimonial.html" class="dropdown-item">Testimonial</a>
                            </div>
                        </div>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase" style="letter-spacing: 5px;">Services</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <h5 class="mb-2">Flexible Payment Options</h5>
                        <p class="m-0">"Offer diverse payment options like hourly rates, daily passes, and semester permits."</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x fa-map-marker-alt mx-auto mb-4"></i>
                        <h5 class="mb-2">Navigation Assistance</h5>
                        <p class="m-0">"Sure! Provide real-time parking updates on a map with GPS guidance for efficient navigation."</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x fa-thumbs-up mx-auto mb-4"></i>
                        <h5 class="mb-2">Students FeedBack</h5>
                        <p class="m-0">"Provide student feedback services to improve the smart parking website and enhance the user experience."</p>
                    </div>
                </div>
            </div>
        </div>
