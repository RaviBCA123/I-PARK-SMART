...
<head>
    ...
    <!-- Favicon -->
    <link href="img/park-logo.png" rel="icon">
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <a href="AdminReport.php" class="nav-item nav-link active">Reports</a>
                    <div class="nav-item dropdown">
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 500px">
                <h3 class="display-4 text-white text-uppercase" style="letter-spacing: 5px;">Report</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Report</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-light shadow" style="padding: 30px;">
            <div class="row align-items-center" style="min-height: 60px;">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            <button class="btn btn-primary btn-block mb-3" onclick="location.href='AdminReportMonthly.php'" style="height: 47px;">Monthly Report</button>
                        </div>
                        <div class="col-md-4">
                            <button class="btn btn-primary btn-block mb-3" onclick="location.href='AdminUsers.php'" style="height: 47px;">PCard User</button>
                        </div>
                        <div class="col-md-4">
                            <button class="btn btn-primary btn-block mb-3" onclick="location.href='AdminReportUsers.php'" style="height: 47px;">Non PCard Users</button>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Initialize Tempus Dominus datetime picker -->
<script>
   $(function () {
