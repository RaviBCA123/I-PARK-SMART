        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3" >I Park Smart</h4>
                            <h1 class="display-3 text-white mb-md-4">Let's Make Parking Smart</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Welcome, <?php echo $_SESSION["username"]; ?></a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3" style="letter-spacing: 5px;">I Park Smart</h4>
                            <h1 class="display-3 text-white mb-md-4">Drive in peace, park with ease</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Welcome, <?php echo $_SESSION["username"]; ?> </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Services</h6>
                <h1 style="font-size: 30px;">Park & Pay Services</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x fa-route mx-auto mb-4"></i>
                        <h5 class="mb-2">Parking Spaces</h5>
                        <p class="m-0"> "Allocate designated parking spaces for students, preferably close to academic buildings."</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x fa-ticket-alt mx-auto mb-4"></i>
                        <h5 class="mb-2">Online Booking</h5>
                        <p class="m-0">"Allow students to reserve parking spaces online in advance to ensure availability during peak times."</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x fa-lock mx-auto mb-4"></i>
                        <h5 class="mb-2">Security Measures</h5>
                        <p class="m-0">"24/7 surveillance, secure access, patrols, and law enforcement integration keep your vehicle safe."</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Packages Start -->
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Packages</h6>
                <h1 style="font-size: 30px;">Pefer Park Packages</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/yearly1.jpg" alt="yearly">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i> Package-1</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i> 365 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i> 1 Person</small>
                            </div>
                            <a class="h5 text-decoration-none">Yearly Parking Pass</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>3.5 <small>(150)</small></h6>
                                    <h5 class="m-0">1200Rs</h5>
                                </div>
                                <a href="userWallet.php" class="btn btn-primary mt-3 add-to-wallet" data-amount="1200">Add To Wallet</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/week1.jpg" alt="monthly">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i> Package-2</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i> 182 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i> 1 Person</small>
                            </div>
                            <a class="h5 text-decoration-none">Monthly Parking Pass</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.2 <small>(350)</small></h6>
                                    <h5 class="m-0">130Rs</h5>
                                </div>
                                <a href="userWallet.php" class="btn btn-primary mt-3 add-to-wallet" data-amount="130">Add To Wallet</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                    <img class="img-fluid" src="img/day.jpg" alt="weekly">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i> Package-3</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i> 30/31 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i> 1 Person</small>
                            </div>
                           <a class="h5 text-decoration-none">Weekly Parking Pass</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.7 <small>(550)</small></h6>
                                    <h5 class="m-0">30Rs</h5>
                                </div>
                                <a href="userWallet.php" class="btn btn-primary mt-3 add-to-wallet" data-amount="30">Add To Wallet</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Select all elements with the class "add-to-wallet"
        var addToWalletButtons = document.querySelectorAll('.add-to-wallet');

        // Loop through each button and add a click event listener
        addToWalletButtons.forEach(function(button) {
            button.addEventListener('click', function(event) {
                event.preventDefault(); // Prevent default link behavior

                // Get the package amount from the data-amount attribute
                var packageAmount = parseInt(button.getAttribute('data-amount'));

                // Set the package amount to a variable
                localStorage.setItem('selectedPackageAmount', packageAmount);

                // Redirect to the userWallet.php page
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Testimonial</h6>
                <h1 style="font-size: 30px;">Student Reviews</h1>
            </div>
            <div class="owl-carousel testimonial-carousel">
                <div class="text-center pb-4">
                    <img class="img-fluid mx-auto" src="img/testimonial-6.jpg" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">"I've been using Park Smart for months now, and I'm consistently impressed with their service."
                        </p>
                        <h5 class="text-truncate">Omkar Garud</h5>
                        <span>TY BCA</span>
                    </div>
                </div>
                <div class="text-center">
                    <img class="img-fluid mx-auto" src="img/testimonial-7.jpg" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">"The rates are reasonable compared to other options in the area. Highly recommend!"
                        </p>
                        <h5 class="text-truncate">Atharva Jagtap</h5>
                        <span>FY BCS</span>
                    </div>
                </div>
                <div class="text-center">
                    <img class="img-fluid mx-auto" src="img/testimonial-8.jpg" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">"The facilities are well-lit and secure, and I appreciate the added peace of mind knowing my vehicle is in good hands."
                        </p>
                        <h5 class="text-truncate">Shivani Sale</h5>
                        <span>TY BCS</span>
                    </div>
                </div>
                <div class="text-center">
                    <img class="img-fluid mx-auto" src="img/testimonial-9.jpg" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">"However, there have been times when the parking lots are overcrowded, leading to difficulty finding a spot even with a reservation"
                        </p>
                        <h5 class="text-truncate">Parth Belhekar</h5>
                        <span>SY BSC</span>
                    </div>
                </div>
                <div class="text-center">
                    <img class="img-fluid mx-auto" src="img/testimonial-5.jpg" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">"Easy to use, provides clear parking information, mobile-friendly, real-time updates."
                        </p>
                        <h5 class="text-truncate">Kirti Deng</h5>
                        <span>TY BCA</span>
                    </div>
                </div>
            </div>
