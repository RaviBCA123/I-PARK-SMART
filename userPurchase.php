...
<head>
    ...
    <style>
        ...
        .confirmation-icon {
            font-size: 100px;
            color: #7AB730; /* Green color for success */
        }
        ...
        .continue-shopping:hover {
            background-color: #7AB730; /* Darker shade of green on hover */
        }
    </style>
</head>
...
<body>
    ...
    <!-- Start Succes Container -->
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="confirmation-container">
                    <i class="fas fa-check-circle confirmation-icon"></i>
                    <h2 class="confirmation-text">Thank you for your purchase!</h2>
                    <p>Money Added successfully.</p>
                    <a href="userWallet.php" class="btn continue-shopping">Go to Wallet</a>
                </div>
            </div>
        </div>
    </div>
    <!-- End Succes Container -->
