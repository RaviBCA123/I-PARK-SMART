...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO comments (name, email, course, message) VALUES ('$name', '$email', '$course', '$message')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<script>alert('Your comment has been submitted successfully. Thank you!');</script>";
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                ...
                                <a href="userComments.php" class="dropdown-item active">CommentUs</a>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase" style="letter-spacing: 5px;">Comment</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="userHome.php">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Comment</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid booking mt-5 pb-5">
        <div class="container pb-5">
            <div class="bg-light shadow" style="padding: 30px;">
                ...
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px; font-size: 20px;">Leave a Comment</h6>
